...
export default function OurProducts() {
  ...
  return (
    ...
    >
      {/* Static Heading - Scrolls normally to free up screen space */}
      <div className="section-shell pt-8 sm:pt-16 lg:pt-24 pb-4 sm:pb-8 shrink-0 flex flex-col gap-2 sm:gap-8 lg:gap-10">
      ...
      {/* Sticky Container takes over when heading scrolls away */}
      <div className="sticky top-0 flex h-screen w-full flex-col overflow-hidden pb-4 sm:pb-16 lg:pb-24">
        {/* Sliding Horizontal Track */}
        <div className="relative flex-1 w-full mt-0 sm:mt-10 lg:mt-16 overflow-hidden">
          <motion.div 
            style={{ x }} 
          ...
          >
            {PRODUCTS.map((product) => (
              <div 
                key={product.name} 
                className="w-[100vw] h-full flex items-start lg:items-center justify-center px-4 sm:px-12 lg:px-24 overflow-y-auto hide-scrollbar pb-8 lg:pb-0"
              >
                <article className="flex w-full max-w-[1200px] flex-col gap-4 sm:gap-8 lg:flex-row lg:items-center lg:gap-12 bg-transparent my-auto lg:my-0">
                  {/* Image */}
