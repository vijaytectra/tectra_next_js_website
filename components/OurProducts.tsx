...
export default function OurProducts() {
  ...
  return (
    ...
    >
      {/* Sticky Container */}
      <div className="sticky top-0 flex h-screen w-full flex-col overflow-hidden pb-4 sm:pb-16 lg:pb-12">

        {/* Sticky Heading */}
        <div className="section-shell pt-6 sm:pt-12 lg:pt-16 pb-0 shrink-0 flex flex-col gap-2 sm:gap-6 lg:gap-8">
            ...
            {PRODUCTS.map((product) => (
              ...
              >
                <article className="flex w-full max-w-[1200px] h-full flex-col gap-2 sm:gap-8 lg:flex-row lg:items-center lg:gap-12 bg-transparent pb-2 lg:pb-0">
                  ...
                  {/* Content */}
                  <div className="flex min-h-0 flex-1 flex-col justify-center gap-2 sm:gap-6 lg:gap-6">
                    ...
                    <div className="flex flex-col gap-3 sm:gap-6 lg:gap-6">
                      <div className="flex flex-col items-start gap-1 sm:gap-3 self-stretch p-3 sm:p-6 lg:p-6 rounded-xl sm:rounded-2xl bg-[#0a0a0a] border border-white/10 relative overflow-hidden max-w-[500px] shadow-lg">
